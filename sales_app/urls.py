...
urlpatterns = [
    ...
    path("admin_view_approved_seller_details/", admin_views.admin_view_approved_seller_details, name = "admin_view_approved_seller_details"),
    ...
    path("payment/<int:buy_object_id>/", customer_views.pay, name = "pay"),
